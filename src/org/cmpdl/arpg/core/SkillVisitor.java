...
/**
 * Visits skills and weapon attacks to use their effects.
...
public interface SkillVisitor {
	...
	void visit(BattleAxeAtk battleAxeAtk);
	void visit(MysticStaffAtk mysticStaffAtk);
	void visit(DaggerAtk daggerAtk);
	void visit(Feast feast);
	void visit(BattleCry battleCry);
	public void visit(Immunity immune);
	void visit(DeathStrike deathStrike);
	void visit(EnemyPhysAtk enemyPhysAtk);
	void visit(EnemyMgcAtk enemyMgcAtk);
	void visit(DeathAtk deathAtk);
}
