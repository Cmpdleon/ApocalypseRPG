...
public class NullMagic implements Armor{
	...
	private static String name = "Null Magic Armor";
	private static Skill skill = new ArmorNull();

	private static NullMagic nullMagic = null;
	public static NullMagic getInstance() {
		if (nullMagic == null) {
			nullMagic = new NullMagic();
		}
		return nullMagic;
	}
