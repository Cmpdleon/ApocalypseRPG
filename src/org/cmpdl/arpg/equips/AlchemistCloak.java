...
public class AlchemistCloak implements Armor{
		...
		private static Skill skill = new ArmorAlchemy();
		
		private static AlchemistCloak alchemy = null;
		public static AlchemistCloak getInstance() {
			if (alchemy == null) {
				alchemy = new AlchemistCloak();
			}
			return alchemy;
		}
		@Override
