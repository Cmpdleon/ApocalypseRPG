...
public class Death implements ApocalypseCharacter{
	private int MAXHP = 210;
	private int MAXMP = 210;
	private int hp = 170;
	private int mp = 170;
	private int atk = 60;
	private int matk = 60;
	...
	private Skill[] skills = {new DeathStrike()};
