...
public class Famine implements ApocalypseCharacter{
	...
	private double mPen = 0.05;
	private int eva = 0;
	private int accu = 100;
	private double hpReg = 0.03;
	private double mpReg = 0.01;
	public String name = "FAMINE";
	...
	private Skill[] skills = {new Feast()};
