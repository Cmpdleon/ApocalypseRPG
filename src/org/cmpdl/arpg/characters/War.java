...
public class War implements ApocalypseCharacter{
	...
	private int matk = 0;
	private int def = 120;
	private int mdef = 110;
	private int spd = 10;
	private double pPen = 0.01;
	private double mPen = 0;
	private int eva = 0;
	private int accu = 100;
	private double hpReg = 0.02;
	private double mpReg = 0.01;
	public String name = "WAR";
	private boolean stunFlag = false;
	private int shield;
	private boolean thornFlag = false;
	
	private WeaponAttack enemyPhysAtk = new EnemyPhysAtk();
	...
	private Skill[] skills = {new BattleCry()};
