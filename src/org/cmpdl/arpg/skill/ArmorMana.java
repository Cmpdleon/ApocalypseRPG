...
public class ArmorMana implements Skill{
	
	private final String name = "Mana Surge";
	private final String desc = "Regen 250 Mana.";
	private final int TYPE = 0;
	private final int COOL = 9;
