...
public class SnowFall implements Skill{
	
	private final String name = "Snow Fall";
	private final String desc = "Deals 62% of M atk. Applies frostbite (2x). Magic.";
	private final int TYPE = 2;
	private final int COOL = 2;
	private final double RATIO = 0.62;
