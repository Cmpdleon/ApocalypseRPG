...
public class IceShard implements Skill{
	
	private final String name = "IceShard";
	private final String desc = "Deals 72% of M akt. Deals 65% more if enemy has frostbite. Magic.";
	...
	public void useEffect() {
		...
		if(flag > 0) SkillMngr.DamageCalcalculation(source, target, RATIO*1.65, SCALING, TYPE);
