...
public class ArmorNull implements Skill{
	
	private final String name = "Null Magic";
	private final String desc = "Increase M def by 50 for 3 turns.";
	...
	public void setCurrCool(int cool) {
		...
		if(cool == 6) {
			source.setMdef(source.getMdef() - 50);
		}
		if(currCool < 0) {
			this.currCool = 0;
		}
