...
public class ArmorReflect implements Skill{
	
	private final String name = "Reflect";
	private final String desc = "Return 100% of the damage taken. True";
